...
<div class="board-wrap">
    <div class="board_post_wrap">
        <div class="div_col">
            ...
            <div><img style="width: 60px; height: 60px" src="/jsp/board/board_movie/board_movie_img/${board.b_img }">
            </div>
            <div class="div_flex">
        ...
        <div class="under_buttons">
            <div class="div_flex">
                <button class="board-reg-btn" onclick="location.href='BoardMovieUpdateC?no=${board.b_no}'">update
                </button>
