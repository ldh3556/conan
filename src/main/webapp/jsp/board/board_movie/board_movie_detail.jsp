...
<div class="board-wrap">
    <div>
        <div>
            ...
            <div><img style="width: 60px; height: 60px" src="/jsp/board/board_movie/board_movie_img/${board.b_img }"></div>
        ...
        <div style="position: relative; bottom: -50px;">
            <button class="board-reg-btn" onclick="location.href='BoardMovieUpdateC?no=${board.b_no}'">update</button>
            <button class="board-reg-btn" onclick="deleteBoard('${board.b_no}')">delete</button>
            <button type="button" class="board-reg-btn" onclick="location.href='BoardMovieC'">list</button>
        </div>
    </div>
    <hr>
    <br>
    ...
    <!-- 댓글 작성 폼 -->
<div>
    <form method="get" action="MovieCommentRegC">
...
<script type="text/javascript">
    function deleteBoard(no) {
        if (confirm('정말로 삭제하시겠습니까?')) {
            alert('삭제 되었습니다.')
            location.href = 'BoardMovieDelC?no=' + no;
        }
    }
