...
public class BoardAnimeDAO {
    ...
    public static void addBoardFree(HttpServletRequest request) {
        ...
        try {
            ...
            String sql = "insert into board_anime_table values(board_anime_table_seq.nextval, ?,?,?,?,?,?, sysdate)";
    ...
    public static void updatBoardFree(HttpServletRequest request) {
        Connection con = null;
        PreparedStatement pstmt = null;
        String sql = "Update board_anime_table set b_begin=?, b_title = ?, b_img = ?, b_text = ? where b_no = ?";
        String no = request.getParameter("no");
