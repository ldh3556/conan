...
public class Vote_worldcupC1_UNUSED extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<VoteDTO_UNUSED> selectedPhotos = (List<VoteDTO_UNUSED>) request.getSession().getAttribute("selectedPhotos");
    ...
    private void updateRound(List<VoteDTO_UNUSED> selectedPhotos, String selectedPhoto, int totalSelections) {
        // 선택된 사진을 기준으로, 선택한 항목을 리스트에서 제거
        VoteDTO_UNUSED selected = null;
        for (VoteDTO_UNUSED photo : selectedPhotos) {
