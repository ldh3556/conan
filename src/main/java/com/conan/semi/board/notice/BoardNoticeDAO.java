...
public class BoardNoticeDAO {
    static ArrayList<BoardNoticeDTO> boards = null;
    ...
    public static void showAllBoardFree(HttpServletRequest request) {
        ...
        try {
            ...
            boards = new ArrayList<BoardNoticeDTO>();
            BoardNoticeDTO board = null;
            while (rs.next()) {
                board = new BoardNoticeDTO();
    ...
    public static void detailBoardFree(HttpServletRequest request) {
        ...
        try {
            ...
            String sql = "select * from board_notice_table where b_no=?";
            con = DBManager.connect();
            pstmt = con.prepareStatement(sql);
    ...
    public static void addBoardFree(HttpServletRequest request) {
        ...
        try {
            ...
            String sql = "insert into board_notice_table values(board_notice_table_seq.nextval, ?,?,?,?,?,?, sysdate)";
    ...
    public static void delBoardFree(HttpServletRequest request) {
        Connection con = null;
        PreparedStatement pstmt = null;
        String sql = "delete from board_notice_table where b_no=?";
        String no = request.getParameter("no");
        try {
            con = DBManager.connect();
            pstmt = con.prepareStatement(sql);
    ...
    public static void updatBoardFree(HttpServletRequest request) {
        Connection con = null;
        PreparedStatement pstmt = null;
        String sql = "Update board_notice_table set b_begin=?, b_title = ?, b_img = ?, b_text = ? where b_no = ?";
        String no = request.getParameter("no");
...
//    request.setAttribute("pageCount", pageCount);
    ...
    ArrayList<BoardNoticeDTO> items = new ArrayList<BoardNoticeDTO>();
    ...
    PreparedStatement pstmt = null;
    ResultSet rs = null;
    String sql = "select * from board_notice_table where b_title like '%'||?||'%'";
    ...
    try {
        ...
        BoardNoticeDTO b = null;
        while (rs.next()) {
            b = new BoardNoticeDTO();
