...
<head>
    ...
    <style>
        * {
        ...
        #next-btn, #retry-btn, #show-answer-btn {
...
<div class="game-container">
    ...
    <button id="next-btn" onclick="nextQuestion()" style="display:none;">다음 문제</button>
...
<script>
    ...
    let usedQuestions = [];  // 이미 사용된 문제의 인덱스를 추적할 배열
    let questionsToAsk = []; // 게임에서 사용할 5개의 문제
