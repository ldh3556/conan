...
CREATE TABLE board_free_comment (
                                     ...
                                     FOREIGN KEY (c_id) REFERENCES account_table_hdh(id) ON DELETE CASCADE,
                                     FOREIGN KEY (c_writer) REFERENCES ACCOUNT_TABLE_HDH(NICKNAME) ON DELETE CASCADE
);

create sequence board_free_comment_seq;

insert into board_free_comment (b_no, c_id ,c_writer, c_content, c_date)values (192, 'dul' ,'호잇이계속되면', '좋은글입니다.', systimestamp);
...
insert into board_movie_comment (b_no, c_id ,c_writer, c_content, c_date)values (209, 'dul','호잇이계속되면', '좋은글입니다.', systimestamp);
...
insert into board_notice_comment (b_no, c_id ,c_writer, c_content, c_date)values (204, 'dul' ,'호잇이계속되면', '좋은글입니다.', systimestamp);
...
insert into board_anime_comment (b_no, c_id, c_writer, c_content, c_date)values (206,'dul' ,'호잇이계속되면', '좋은글입니다.', systimestamp);
